...
`);
    ...
    const commands = ['prepare', 'inspect', 'regenerate', 'create-bot', 'configure-bot', 'record-native', 'inventory', 'verify-migration'];
    ...
    let result;
    if (command === 'inventory') result = inventory(values.source, values.output);
